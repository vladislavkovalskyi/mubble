...
from mubble.msgspec_utils import DataclassInstance, encoder
...
class Button(BaseButton):
    ...
    request_chat: dict[str, typing.Any] | KeyboardButtonRequestChat | None = (
        dataclasses.field(default=None, kw_only=True)
    )
    request_user: dict[str, typing.Any] | KeyboardButtonRequestUsers | None = (
        dataclasses.field(default=None, kw_only=True)
    )
    request_poll: dict[str, typing.Any] | KeyboardButtonPollType | None = (
        dataclasses.field(default=None, kw_only=True)
    )
    web_app: dict[str, typing.Any] | WebAppInfo | None = dataclasses.field(
...
class InlineButton(BaseButton):
    ...
    login_url: dict[str, typing.Any] | LoginUrl | None = dataclasses.field(
        default=None, kw_only=True
    )
    ...
    callback_game: dict[str, typing.Any] | CallbackGame | None = dataclasses.field(
        default=None, kw_only=True
    )
